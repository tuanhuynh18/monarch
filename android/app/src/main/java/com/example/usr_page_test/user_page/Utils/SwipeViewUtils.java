...
public class SwipeViewUtils implements EnterDialogFragment.InputListener {
    private Switch btn;
    private TextView te;
...
//    }
    ...
    public void create_swipe_list(Context context, BudgetPageActivity ba, SwipeMenuListView view) {
        swipeMenuView =  view;
        create_bean(context, ba);
    }

    public void create_bean(Context context, BudgetPageActivity ba){
