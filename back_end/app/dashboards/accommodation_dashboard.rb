...
class AccommodationDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how accommodations are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(accommodation)
