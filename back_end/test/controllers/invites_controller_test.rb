...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invite" do
    assert_difference("Invite.count") do
      post invites_url, params: { invite: { status: @invite.status, trip_id: @invite.trip_id, user_id: @invite.user_id } }
    end
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { status: @invite.status, trip_id: @invite.trip_id, user_id: @invite.user_id } }
